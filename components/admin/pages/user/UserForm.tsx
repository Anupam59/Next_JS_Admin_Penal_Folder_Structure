...
import type { User, UserRole, UserStatus } from "@/types/admin/user.type"
...
const RichTextEditor = dynamic(
  () =>
    import("@/components/admin/ui/rich-text-editor").then(
      (module) => module.RichTextEditor
    ),
  {
    ssr: false,
    loading: () => (
      <div className="min-h-32 rounded-md bg-slate-100 px-3 py-2 text-sm text-slate-400 dark:bg-white/5">
        Loading editor...
      </div>
    ),
  }
